...
async fn test_get_astronomy_validation_latitude_high() {
    ...
    let result = service.get_astronomy(90.001, 11.6, None).await;
...
async fn test_get_astronomy_validation_longitude_high() {
    ...
    let result = service.get_astronomy(48.1, 180.001, None).await;
...
async fn test_get_astronomy_validation_forecast_days_zero() {
    ...
    let result = service.get_astronomy(48.1, 11.6, Some(0)).await;
...
async fn test_get_astronomy_validation_forecast_days_too_high() {
    ...
    let result = service.get_astronomy(48.1, 11.6, Some(17)).await;
...
async fn test_get_astronomy_boundary_coordinates() {
    ...
    let result = service.get_astronomy(90.0, 180.0, Some(7)).await;
