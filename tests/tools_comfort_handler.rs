...
async fn test_get_comfort_index_validation_latitude_high() {
    ...
    let result = service.get_comfort_index(90.001, 11.6, None, None).await;
...
async fn test_get_comfort_index_validation_longitude_high() {
    ...
    let result = service.get_comfort_index(48.1, 180.001, None, None).await;
...
async fn test_get_comfort_index_validation_forecast_days_zero() {
    ...
    let result = service.get_comfort_index(48.1, 11.6, None, Some(0)).await;
...
async fn test_get_comfort_index_validation_forecast_days_too_high() {
    ...
    let result = service.get_comfort_index(48.1, 11.6, None, Some(17)).await;
...
async fn test_get_comfort_index_boundary_latitude() {
    ...
    let result = service.get_comfort_index(90.0, 11.6, None, Some(5)).await;
...
async fn test_get_comfort_index_boundary_longitude() {
    ...
    let result = service.get_comfort_index(48.1, 180.0, None, Some(5)).await;
...
async fn test_get_comfort_index_boundary_forecast_days() {
    ...
    let result = service.get_comfort_index(48.1, 11.6, None, Some(16)).await;
